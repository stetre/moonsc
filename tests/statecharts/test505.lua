...
return _scxml{ initial="s1",
   _datamodel{
      _data{ id="var1", expr="0" }, -- how often we have exited s1 
      _data{ id="var2", expr="0" }, -- how often we have exited s11 
   ...
   _state{ id="s1",
      ...
      _transition{ event="foo", type="internal", target="s11",
         _assign{ location="var3", expr="var3+1" },
      }, 
     -- make sure the transition on foo was actually taken  
      _transition{ event="bar", cond="var3==1", target="s2" },
   ...
   _state{ id="s2",
      ...
      _transition{ cond="var1==1", target="s3" },
